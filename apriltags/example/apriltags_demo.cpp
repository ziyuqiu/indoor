...
public:
  ...
  void print_detection(AprilTags::TagDetection& detection) const {
    ...
    //publishLatLong(translation(0),translation(1));
    ...
    double y = -( (cos(yaw)*translation(1)) - (sin(yaw)*translation(2)));
    double z = -( (cos(yaw)*translation(2)) + (sin(yaw)*translation(1)));
    ...
    cout << "camera frame distances, y=" <<  y << ", z=" << z << ", yaw=" << yaw << endl;
  ...
  //void publishLatLong(double x, double y){
  //    
  //}
